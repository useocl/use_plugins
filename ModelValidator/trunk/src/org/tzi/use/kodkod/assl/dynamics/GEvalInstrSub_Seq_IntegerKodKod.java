 ...
 * eval sub
 * 
 * based on {@link GEvalInstrSub_Seq_Integer}
 * 
 * @author Juergen Widdermann
 */
public class GEvalInstrSub_Seq_IntegerKodKod extends GEvalInstruction implements IGCaller {
    ...
    public GEvalInstrSub_Seq_IntegerKodKod(GInstrSub_Seq_Integer instr ) {
        fInstr = instr;
    }
    ...
    public void feedback( GConfiguration conf,
        ...
        if (fSequence == null) {
            if (value.isUndefined())
                ...
                GCreatorKodKod.createFor(fInstr.integerInstr())
