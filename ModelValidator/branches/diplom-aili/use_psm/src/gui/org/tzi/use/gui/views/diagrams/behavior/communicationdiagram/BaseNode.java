...
public abstract class BaseNode extends PlaceableNode {
	...
	private List<String> lifeStatesList;
	...
	public BaseNode(CommunicationDiagramView parent, DiagramOptions opt) {
		comDiaView = parent;
		fOpt = opt;
		lifeStatesList = new ArrayList<String>();
	...
	/**
	 * Add new life state for the node
	 * 
	 * @param stateString
	 *            given life state as string
	 */
	void addState(String state) {
		this.lifeStatesList.add(state);
	}

	/**
	 * Return list of life states
	 * 
	 * @return a list of life states
	 */
	public List<String> getStates() {
		return this.lifeStatesList;
	}
	...
	void updateState(String state) {
		if (lifeStatesList.size() > 0) {
			this.lifeStatesList.set(lifeStatesList.size() - 1, state);
		}
	}
	...
	public String getLifeStatesString() {
		String result = "";
		for (String lifeState : lifeStatesList) {
			result += lifeState;
		}
		return result;
	}
