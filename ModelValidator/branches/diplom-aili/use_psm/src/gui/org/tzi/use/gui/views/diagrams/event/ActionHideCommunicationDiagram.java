...
public final class ActionHideCommunicationDiagram extends ActionHide<Object> {
	
	public ActionHideCommunicationDiagram(String text, Set<Object> nodesToHide,
	...
	@Override
	public void showHiddenElements(Set<Object> hiddenElements) {
		getDiagram().showNodes(hiddenElements);
    	getDiagram().repaint();
	}
