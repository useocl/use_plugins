...
public class ObjectSelection {
	...
	TreeSet<PlaceableNode> sortedNodes = new TreeSet<PlaceableNode>(sort);
	sortedNodes.addAll(diagram.getVisibleData().getNodes());

	Map<MClass, JMenu> classMenus = new HashMap<MClass, JMenu>();
	for (PlaceableNode node : sortedNodes) {
	...
	showAllObjects.setEnabled(diagram.getHiddenData().hasNodes());
