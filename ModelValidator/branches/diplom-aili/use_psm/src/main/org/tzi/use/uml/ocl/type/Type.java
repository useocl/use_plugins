...
public abstract class Type implements BufferedToString {
    ...
    /** 
     * Returns <code>true</code> if this type is equal to <code>t</code> 
     * or is a subtype of <code>t</code>.
     */
    ...
    /**
     * Returns <code>true</code>, if the current type
     * is equals to <code>CollectionType</code>.
	...
	public Type getLeastCommonSupertype(Type type) {
        ...
        if (this.isObjectType()) {
        	...
        	Set<MClass> allP = CollectionUtil.downCastUnsafe(oTypeOther.cls().allParents());
        	Set<MClass> allSuperClassesOther = new HashSet<MClass>(allP);
