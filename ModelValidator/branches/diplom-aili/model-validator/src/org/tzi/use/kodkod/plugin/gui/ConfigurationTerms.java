...
public class ConfigurationTerms {
	...
	public static final String ATTRIBUTES_MINSIZE = "Min. Elements";
	public static final String ATTRIBUTES_MAXSIZE = "Max. Elements";
	public static final String ATTRIBUTES_VALUES = "Possible Values";
	
	public static final String ASSOCIATIONS_MIN = "Min. Links";
