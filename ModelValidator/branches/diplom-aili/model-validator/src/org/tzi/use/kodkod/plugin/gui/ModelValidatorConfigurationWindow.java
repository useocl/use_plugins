...
public class ModelValidatorConfigurationWindow extends JDialog {
	...
	private JPanel basicTypesPanel() {
		...
		JCheckBox integerCheckbox = new JCheckBox(TypeConstants.INTEGER, DefaultConfigurationValues.integerEnabled);
		...
		if(DefaultConfigurationValues.integerEnabled){
			integerPanel.add(intScroll, BorderLayout.CENTER);
		}
		...
		JCheckBox stringCheckbox = new JCheckBox(TypeConstants.STRING, DefaultConfigurationValues.stringEnabled);
		...
		if(DefaultConfigurationValues.stringEnabled){
			stringPanel.add(stringScroll, BorderLayout.CENTER);
		}
		...
		JCheckBox realCheckbox = new JCheckBox(TypeConstants.REAL, DefaultConfigurationValues.realEnabled);
		...
		if(DefaultConfigurationValues.realEnabled){
			realPanel.add(realScroll, BorderLayout.CENTER);
		}
		panel.add(realPanel);
