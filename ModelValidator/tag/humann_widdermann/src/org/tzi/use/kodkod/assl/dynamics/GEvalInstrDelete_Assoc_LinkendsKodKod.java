...
/**
 * eval delete association
 * 
 * based on {@link GEvalInstrDelete_Assoc_LinkendsKodKod}
 * 
 * @author Juergen Widdermann
 */
public class GEvalInstrDelete_Assoc_LinkendsKodKod extends GEvalInstruction implements IGCaller {
    ...
    public GEvalInstrDelete_Assoc_LinkendsKodKod(GInstrDelete_Assoc_Linkends instr ) {
        fInstr = instr;
    }
