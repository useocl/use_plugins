...
extends UMLUtil {
	...
	public static ResourceSet init(ResourceSet resourceSet) throws Exception {
		...
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_2_1_1_NS_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_2_1_1_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_2_1_NS_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_2_1_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_2_2_NS_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_NS_URI,
				UMLPackage.eINSTANCE);
		packageRegistry.put(XMI2UMLResource.UML_METAMODEL_URI,
				UMLPackage.eINSTANCE);
