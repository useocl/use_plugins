...
/**
 * transformation of application to filmstrip model using C@Snap Aggregation
 * 
 * @author Nisha desai
 * 
 */
...
public class FilmstripMVCOpCSnapAggVisitor extends FilmstripMMVisitor {

	public static final String NAME = "Model validator compatible transformation using C@Snap Agg";
	
	private FilmstripMVCOpCSnapAggVisitor(String modelName) {
		super(modelName);
	}
	
	public static MModel transformModel(MModel model, String modelName){
		FilmstripMMVisitor visitor = new FilmstripMVCOpCSnapAggVisitor(modelName);
