...
/**
 * transformation of application to filmstrip model using SnapCSnap Association
 * 
 * @author Nisha desai
 * 
 */

public class FilmstripMVCSnapCSnapAssocVisitor extends FilmstripMMVisitor {

	public static final String NAME = "Model validator compatible transformation using SnapCSnap Assoc";
	
	private FilmstripMVCSnapCSnapAssocVisitor(String modelName) {
		super(modelName);
	}
	
	public static MModel transformModel(MModel model, String modelName){
		FilmstripMMVisitor visitor = new FilmstripMVCSnapCSnapAssocVisitor(modelName);
