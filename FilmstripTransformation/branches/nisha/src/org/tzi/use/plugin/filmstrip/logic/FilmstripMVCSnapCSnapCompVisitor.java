...
/**
 * transformation of application to filmstrip model using SnapCSnap Composition
 * 
 * @author Nisha desai
 * 
 */

public class FilmstripMVCSnapCSnapCompVisitor extends FilmstripMMVisitor {

	public static final String NAME = "Model validator compatible transformation using SnapCSnap Comp";
	
	private FilmstripMVCSnapCSnapCompVisitor(String modelName) {
		super(modelName);
	}
	
	public static MModel transformModel(MModel model, String modelName){
		FilmstripMMVisitor visitor = new FilmstripMVCSnapCSnapCompVisitor(modelName);
