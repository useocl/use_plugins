...
/**
 * transformation of application to filmstrip model using C@Snap Composition
 * 
 * @author Nisha desai
 * 
 */

public class FilmstripMVCOpCSnapCompVisitor extends FilmstripMMVisitor {

	public static final String NAME = "Model validator compatible transformation using C@Snap Comp";
	
	private FilmstripMVCOpCSnapCompVisitor(String modelName) {
		super(modelName);
	}
	
	public static MModel transformModel(MModel model, String modelName){
		FilmstripMMVisitor visitor = new FilmstripMVCOpCSnapCompVisitor(modelName);
