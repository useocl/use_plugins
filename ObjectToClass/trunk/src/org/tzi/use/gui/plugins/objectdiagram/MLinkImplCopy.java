...
// $Id: MLinkImpl.java 5494 2015-02-05 12:59:25Z lhamann $
 ...
 * 
 * FIXME start
 * This is just a copy of the MLinkImpl class to avoid changing the visibility 
 * of the original class. This is not a good solution and should be changed.
 * FIXME end
 *
 * @author Mark Richters
 * @author Lars Hamann
 */
class MLinkImplCopy implements MLink {
     ...
     *            association ends.
     */
    protected MLinkImplCopy(MAssociation assoc, List<MObject> objects, List<List<Value>> qualifierValues) throws MSystemException {
        fAssociation = assoc;
